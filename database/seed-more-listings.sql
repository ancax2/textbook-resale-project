-- Run this file to add more sample listings to your existing database.
-- Usage: mysql -u root -p textbook_resale < seed-more-listings.sql
-- (Or run the INSERT below in MySQL Workbench / your DB tool)
